  ...
  <form id="article_form" method="post" name="articleForm" enctype="multipart/form-data">
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><select name="ac_id" id="ac_id">
              <option value="">请选择...</option>
 			  <?php if(is_array($ac_list)): $i = 0; $__LIST__ = $ac_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v['ac_id']); ?>"><?php echo ($v['ac_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select></td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" name="article_key" id="article_key" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>       
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><textarea id="article_desc" class="tarea" rows="6" name="article_desc"></textarea></td>
          <td class="vatop tips"></td>
        </tr>       
...
<!--        <tr>
        ...
        <tr class="noborder">
         <td class="vatop rowform">  
            ...
            <div class="type-file-preview"><img src="/Uploads/<?php echo ($rs['article_pic']); ?>"></div>
            </span>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="10" name="article_sort" id="article_sort" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          ...
          <?php kindEditor('article_content');?></td>
        </tr>
      </tbody>
      <tfoot>
        <tr class="tfoot">
