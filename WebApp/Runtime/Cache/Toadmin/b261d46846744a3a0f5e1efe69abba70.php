...
<div class="page">
  ...
  <form id="article_class_form" method="post">
    <input type="hidden" name="ac_id" value="<?php echo ($vo['ac_id']); ?>" />
...
<!--        <tr>
        ...
        <?php if(is_array($ac_list)): $i = 0; $__LIST__ = $ac_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option  value="<?php echo ($v["ac_id"]); ?>" <?php if($v['ac_id'] == $vo['ac_parent_id']): ?>selected="selected"<?php endif; ?>><?php echo ($v["ac_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
        </td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo ($vo['ac_name']); ?>" name="ac_name" id="ac_name" class="txt"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo ($vo['ac_title']); ?>" name="ac_title" id="ac_title" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo ($vo['ac_key']); ?>" name="ac_key" id="ac_key" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><textarea name="ac_desc" rows="6" class="w300" id="ac_desc"><?php echo ($vo['ac_desc']); ?></textarea></td>
          <td class="vatop tips"></td>
        </tr>                        
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo ($vo['ac_sort']); ?>" name="ac_sort" id="ac_sort" class="txt"></td>
